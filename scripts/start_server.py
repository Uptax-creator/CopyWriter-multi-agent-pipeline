...
def main():
    print("🚀 Iniciando servidor HTTP do Omie MCP v2.0.0...")
    ...
    try:
        result = subprocess.run([
            python_cmd, "-c", 
            "import fastapi, uvicorn, httpx, pydantic; print('✅ Dependências OK')"
    ...
    print(f"• Arquitetura: Híbrida (HTTP + MCP)")
    print(f"• Porta: {port}")
    ...
    print("1. Execute em outro terminal: python scripts/configure_claude.py")
